      ...
      <div className="flex flex-1">
        ...
        <aside className="w-64 border-r hidden md:block p-4">
          <nav className="space-y-2 text-sm">
            <div className="rounded px-3 py-2 bg-muted font-medium">Dashboard</div>
            <div className="rounded px-3 py-2 text-muted-foreground">Capture</div>
            <div className="rounded px-3 py-2 text-muted-foreground">Concepts</div>
            <div className="rounded px-3 py-2 text-muted-foreground">Learn</div>
          </nav>
        </aside>
